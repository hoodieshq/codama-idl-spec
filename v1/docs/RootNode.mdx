...
| Attribute            | Type                                 | Description                                            |
| -------------------- | ------------------------------------ | ------------------------------------------------------ |
| `program`            | [`ProgramNode`](./ProgramNode.mdx)   | The primary program described by the document.         |
| `additionalPrograms` | [`ProgramNode`](./ProgramNode.mdx)[] | Additional programs referenced by the primary program. |
