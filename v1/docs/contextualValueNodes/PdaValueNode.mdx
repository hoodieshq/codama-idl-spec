...
| Attribute   | Type                                                        | Description                                                                              |
| ----------- | ----------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| `pda`       | [`PdaValuePda`](./PdaValuePda.mdx)                          | The PDA being derived — either a link to a defined PDA or an inline `pdaNode`.           |
| `seeds`     | [`PdaSeedValueNode`](./PdaSeedValueNode.mdx)[]              | The seed values used to derive the PDA, paired with their seed names.                    |
| `programId` | [`PdaValueProgramId`](./PdaValueProgramId.mdx) _(optional)_ | The program ID used to derive the PDA. When omitted, the PDA’s declared program is used. |
