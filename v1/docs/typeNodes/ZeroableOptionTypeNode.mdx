...
| `zeroValue` | [`ConstantValueNode`](../valueNodes/ConstantValueNode.mdx) _(optional)_ | The constant value that signals absence. When omitted, the all-zero byte pattern of the item type is used. |
